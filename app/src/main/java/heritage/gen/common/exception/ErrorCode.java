package heritage.gen.common.exception;
...
public enum ErrorCode {
    ...
    USER_ALREADY_EXISTS(8002, "用户已存在"),
    USER_PASSWORD_INCORRECT(8003, "密码错误"),
    USER_ACCOUNT_BANNED(8004, "账号已被封禁"),
    USER_TOKEN_EXPIRED(8005, "登录已过期，请重新登录"),
    USER_TOKEN_INVALID(8006, "无效的登录凭证"),
